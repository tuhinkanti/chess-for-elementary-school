...
import { extractJson, validateTutorRequest, constructSystemPrompt, type GameContext } from '../src/utils/aiUtils.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        ...
        // Build the full prompt securely with system context and conversation history
